            ...
            <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-3 gap-10 text-center sm:text-left">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        ...
                        <li><a href="mailto:support@shopsutra.com" className="hover:text-blue-600">support@shopsutra.com</a></li>
                        <li><a href="tel:+911234567890" className="hover:text-blue-600">+91 12345 67890</a></li>
                    </ul>
                </div>
            </div>
