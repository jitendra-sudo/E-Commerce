...
function LetterBox() {
    return (
        <div className="w-full bg-gray-50 py-6 px-4 mx-auto">
            <div className="max-w-3xl mx-auto text-center">
                <h2 className="text-md md:text-base text-black font-medium">
                    Subscribe Now & Get <span className="text-blue-600 font-bold">20% Off</span>
                </h2>
